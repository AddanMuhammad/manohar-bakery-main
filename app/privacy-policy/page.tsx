  ...
  return (
    <MainLayout>
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        <h1 className='text-4xl font-bold text-secondary text-center mb-4'>Privacy Policy</h1>
        ...
        <div className='flex flex-col gap-8 text-secondary/90'>
          <section>
            ...
            <p className='mb-4'>
              Welcome to Manohar Bakery Fleetwood ("we," "our," or "us"). We are committed to protecting your privacy and ensuring you have a positive experience on our website and in our store. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website, place orders, or interact with our services.
            </p>
          </section>
          ...
          <section>
            ...
            <div className='flex flex-col gap-3'>
              <div>
                <h3 className='text-xl font-semibold text-secondary mb-2'>2.1 Personal Information</h3>
                ...
                <ul className='list-disc list-inside ml-4 space-y-1'>
                  ...
                  <li>Any other information you choose to provide when contacting us or placing orders</li>
                </ul>
              </div>
              <div>
                <h3 className='text-xl font-semibold text-secondary mb-2'>2.2 Automatically Collected Information</h3>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-secondary mb-4'>4. Information Sharing and Disclosure</h2>
            <p className='mb-4'>
              We do not sell your personal information. We may share your information only in the following circumstances:
            </p>
            <ul className='list-disc list-inside ml-4 space-y-1'>
              <li><strong>Service Providers:</strong> We may share information with third-party service providers who perform services on our behalf, such as payment processing, order fulfillment, and website hosting.</li>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-secondary mb-4'>5. Data Security</h2>
            <p className='mb-4'>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-secondary mb-4'>6. Your Rights and Choices</h2>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-secondary mb-4'>7. Cookies and Tracking Technologies</h2>
            <p className='mb-4'>
              Our website may use cookies and similar tracking technologies to enhance your experience, analyze usage patterns, and improve our services. You can control cookie preferences through your browser settings, though this may affect website functionality.
            </p>
          </section>
          ...
          <section>
            <h2 className='text-2xl font-semibold text-secondary mb-4'>9. Changes to This Privacy Policy</h2>
            <p className='mb-4'>
