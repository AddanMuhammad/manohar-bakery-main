      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex flex-col gap-8 text-secondary/90">
          <section>
            ...
            <p className="mb-4">
              By accessing and using the Manohar Bakery Fleetwood website
              ("Website") and our services, you accept and agree to be bound by
          ...
          <section>
            ...
            <p className="mb-4">
              Manohar Bakery Fleetwood is a vegetarian bakery located at
              Fruiticana & BMO plaza, 15905 Fraser Hwy Unit 101, Surrey, BC V4N
              0Y3. We specialize in fresh, eggless baked goods including custom
              cakes, breads, cookies, and pastries.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="flex flex-col gap-3">
              <p className="mb-2">
                We offer a variety of baked goods and custom cake services. All
                products are:
              </p>
              ...
              <p className="mt-4">
                ...
                only. Actual products may vary slightly in appearance.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="flex flex-col gap-3">
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    Orders can be placed through our website, by phone, or
                    in-store
                  </li>
                  ...
                  <li>
                    Custom orders may require advance notice and confirmation
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    All prices are in Canadian Dollars (CAD) unless otherwise
                    stated
                  </li>
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>
                    Payment is required at the time of order placement or upon
                    pickup/delivery
                  </li>
          ...
          <section>
            ...
            <div className="flex flex-col gap-3">
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>
                  Orders can be picked up at our store location during business
                  hours
                </li>
                <li>
                  Delivery options and fees (if available) will be discussed at
                  the time of order
                </li>
                <li>
                ...
                <li>
                  We are not liable for delays caused by factors beyond our
                  control
                </li>
                <li>
                  Products must be picked up within the agreed timeframe or may
                  be subject to additional storage fees
                </li>
              </ul>
            </div>
          </section>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div>
                ...
                <ul className="list-disc list-inside ml-4 space-y-1">
                  ...
                  <li>
                    Refunds for custom orders may not be available once
          ...
          <section>
            ...
            <p className="mb-4">
              While we take care to prepare eggless and vegetarian products, our
              bakery may process ingredients that contain allergens (such as
              nuts, dairy, gluten, etc.). Please inform us of any allergies or
              dietary restrictions when placing your order. We cannot guarantee
              that our products are free from cross-contamination with
              allergens.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              images, and software, is the property of Manohar Bakery Fleetwood
          ...
          <section>
            ...
            <p className="mb-4">
              To the fullest extent permitted by law, Manohar Bakery Fleetwood
          ...
          <section>
            ...
            <p className="mb-4">
              You agree to indemnify and hold harmless Manohar Bakery Fleetwood,
              its employees, and affiliates from any claims, damages, losses,
              liabilities, and expenses (including legal fees) arising out of or
              relating to your use of our services, violation of these Terms, or
          ...
          <section>
            ...
            <p className="mb-4">
              ...
              page. Your continued use of our services after changes are posted
